...
namespace CoronaApp.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ILocationRespository, LocationRespository>();
            services.AddScoped<IPatientRespository, PatientRespository>();


            services.AddDbContext<CoronaAppContext>(item => item.UseSqlServer(Configuration.GetConnectionString("connectionDBMiriam")));
